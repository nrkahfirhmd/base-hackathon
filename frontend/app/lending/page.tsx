    ...
    <div className="flex items-center justify-between mb-8">
      ...
      <section className="grid grid-cols-1 gap-2 mb-6">
        ...
        <div className="flex gap-3 mb-4">
            ...
            className="flex-1 rounded-xl bg-white/5 px-4 py-3 text-white outline-none"
            placeholder="Amount"
            />
            ...
            className="w-28 rounded-xl bg-white/5 px-3 py-3 text-white outline-none"
            >
        ...
        <div className="flex gap-3">
            <SecondaryButton className="flex-1" onClick={() => { setAmountInput("1"); setToken("eth"); setRec(null); }}>
            Reset
            </SecondaryButton>
